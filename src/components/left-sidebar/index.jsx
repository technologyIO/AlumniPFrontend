        ...
        <div style={{ width: '20%', marginLeft: '25px' }}>
                <div className='sideBar'>
                    <ul>
                        ...
                        <li><Link to="/donations" style={{ textDecoration: 'none' }}><BsCurrencyRupee style={{ color: '#c8d1da' }} /><p>Donations</p></Link></li>
                        ...
                        <li><Link to="/jobs" style={{ textDecoration: 'none' }}><FaBriefcase style={{ color: '#407093' }} /><p>Jobs</p></Link></li>
