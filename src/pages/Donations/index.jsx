...
const Donations = () => {
  ...
  const buttontext1 = 'Browse Donations';
  const buttontext2 = 'My Donation Requests';
  ...
  const getPosts = async () => {
    ...
    try {
      const response = await axios.get(
        `http://34.229.93.25:5000/donations?page=${page}&size=${LIMIT}`
      );
  ...
  const getUserDonations = async () => {
    try {
      const response = await axios.get(
        `http://34.229.93.25:5000/donations/user/${profile._id}`
      );
  ...
  return (
    <div style={{ width: '60%', height: '120vh' }}>
      ...
      <Routes>
        <Route path="/" element={<PageSubTitle buttontext1={buttontext1} buttontext2={buttontext2} buttontext1Link={buttontext1Link} buttontext2Link={buttontext2Link} name='donations' create={true}/>} />
        <Route path="/my-donation-requests" element={<PageSubTitle buttontext1={buttontext1} buttontext2={buttontext2} buttontext1Link={buttontext1Link} buttontext2Link={buttontext2Link} name='donations' create={true}/>} />
