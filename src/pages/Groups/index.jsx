...
const Groups = () => {
  ...
  const buttontext3Link = "/groups/joined-groups";
  ...
  return (
    <div style={{ width: '60%', paddingTop: '20px' }}>
      <Routes>
        ...
        <Route path="/joined-groups" element={<PageTitle title={title} icon={icon} />} />
      ...
      <Routes>
        ...
        {admin ? (
          <Route path="/suggested-groups" element={<PageSubTitle buttontext1={buttontext1} buttontext2={buttontext2} buttontext3={buttontext3} buttontext1Link={buttontext1Link} buttontext2Link={buttontext2Link} buttontext3Link={buttontext3Link} name='groups' create={true}/>} />
        ) : (
        ...
        {admin ? (
          <Route path="/joined-groups" element={<PageSubTitle buttontext1={buttontext1} buttontext2={buttontext2} buttontext3={buttontext3} buttontext1Link={buttontext1Link} buttontext2Link={buttontext2Link} buttontext3Link={buttontext3Link} name='groups' create={true}/>} />
        ) : (
          <Route path="/joined-groups" element={<PageSubTitle buttontext1={buttontext1} buttontext2={buttontext2} buttontext3={buttontext3} buttontext1Link={buttontext1Link} buttontext2Link={buttontext2Link} buttontext3Link={buttontext3Link} name='groups' create={false}/>} />
        )}
